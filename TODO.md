...
- [ ] **[src/DvpCameraCapture.cpp]** - 第322行："TODO(cmx) 这个一定要重新写,只是因为现在还没确定好CameraConfig的通用范围。"，需要重新实现相机配置的通用范围
...
- [ ] **[src/FrameProcessor.hpp]** - 第137行："TODO: 实现图像拼接、去重、对齐"，在MultiCameraFusionProcessor中实现图像融合功能
